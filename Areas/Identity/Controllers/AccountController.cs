    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Thay vào đó, chuyển hướng đến trang đăng nhập với thông báo
                    TempData["StatusMessage"] = "Đăng ký thành công! Vui lòng kiểm tra email để xác nhận tài khoản.";
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            if (result.Succeeded)
            {
                ...
                TempData["StatusMessage"] = "Xác nhận email thành công! Bạn có thể đăng nhập ngay bây giờ.";
                // Chuyển hướng đến trang đăng nhập với layout phù hợp
                return RedirectToAction("Login", "Account", new { area = "Identity" });
            }
